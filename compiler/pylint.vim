...
"CompilerSet makeprg=(echo\ '[%]';~/.vim/plugin/pylint/bin/pylint\ --rcfile\ ~/pylint.rc\ -i\ y\ %\\\|grep\ -e\ \'^[WECY]\'\\\|sed\ -e\ \'s/^E/1\ E\ /\'\ -e\ \'s/^W/2\ W\ /\'\ -e\ \'s/^C/3\ C\ /\'\ -e\ \'s/:[\.\ _a-Z]*:/:/g\'\ \\\|sort\ -k1,3)
CompilerSet makeprg=(echo\ '[%]';\ ~/.vim/plugin/pylint/bin/pylint\ --rcfile\ ~/.vim/plugin/pylint/pylintrc\ -r\ y\ %)
